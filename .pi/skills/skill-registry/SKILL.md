...
- Always write `.arc/skill-registry.md` regardless of SDD persistence mode.
...
- Add `.arc/` to `.gitignore` when possible unless explicitly disabled.
...
3. Render `.arc/skill-registry.md` with scanned sources, registry contract, skill name, trigger/description, scope, and exact path.
...
Return:
- Project name and `.arc/skill-registry.md` path.
...
- `docs/skill-style-guide.md` â€” how skills should be authored before indexing.
- `skills/_shared/skill-resolver.md` â€” how delegators use the index.
